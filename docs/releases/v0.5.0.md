...
provider := realtime.NewProvider(os.Getenv("GEMINI_API_KEY"),
...
provider := googleRealtime.NewProvider(os.Getenv("GEMINI_API_KEY"),
...
See the [Gemini Live API Guide](../omnivoice/realtime.md) for detailed usage.
